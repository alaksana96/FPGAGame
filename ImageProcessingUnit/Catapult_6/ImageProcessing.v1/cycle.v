...
//  Generated date: Tue May 10 13:39:36 2016
// ----------------------------------------------------------------------
...
module ImageProcessing_core (
  ...
  begin : core
    ...
    reg land_lpi_1_dfm;
    reg else_1_slc_svs;
    reg else_1_land_1_sva_1;
    reg else_1_land_1_lpi_1_dfm;
    reg else_1_land_sva_1;
      ...
      forever begin : core_rlp
        ...
        begin : mainExit
          forever begin : main
            ...
            else_1_land_sva_1 = 1'b0;
            else_1_land_1_sva_1 = 1'b0;
            land_sva_1 = 1'b0;
            land_1_sva_1 = 1'b0;
            io_read_video_in_rsc_d_cse_sva = video_in_rsc_mgc_in_wire_d;
            vga_y_sva = (vga_xy_rsc_mgc_in_wire_d[19:10]) + 10'b1111011101;
            io_read_VGA_VS_rsc_d_svs = VGA_VS_rsc_mgc_in_wire_d;
            findpixelred_sva_dfm = findpixelred_sva | io_read_VGA_VS_rsc_d_svs;
            findpixelblue_sva_dfm = findpixelblue_sva | io_read_VGA_VS_rsc_d_svs;
            ...
            if ( land_lpi_1_dfm ) begin
              ...
              else_1_slc_svs = readslicef_11_1_10((({1'b1 , (~ (io_read_video_in_rsc_d_cse_sva[29:20]))})
                  + 11'b110010001));
              if ( else_1_slc_svs ) begin
              end
              else begin
                else_1_land_1_sva_1 = ~ (readslicef_11_1_10((({1'b1 , (~ (io_read_video_in_rsc_d_cse_sva[19:10]))})
                    + 11'b110010001)));
              end
              else_1_land_1_lpi_1_dfm = else_1_land_1_sva_1 & (~ else_1_slc_svs);
              if ( else_1_land_1_lpi_1_dfm ) begin
                else_1_land_sva_1 = ~ (readslicef_9_1_8((conv_u2u_8_9(io_read_video_in_rsc_d_cse_sva[9:2])
                    + 9'b110000011)));
              end
              else_1_land_lpi_1_dfm = else_1_land_sva_1 & else_1_land_1_lpi_1_dfm;
              if ( else_1_land_lpi_1_dfm ) begin
                player2y_rsc_mgc_out_stdreg_d <= MUX_v_10_2_2({blueobjy_sva , vga_y_sva},
                    findpixelblue_sva_dfm);
              end
            end
            video_out_rsc_mgc_out_stdreg_d <= {({{9{land_lpi_1_dfm}}, land_lpi_1_dfm})
                , 10'b0 , (signext_10_1(else_1_land_lpi_1_dfm & (~ land_lpi_1_dfm)))};
            findpixelred_sva = findpixelred_sva_dfm & (~ land_lpi_1_dfm);
            findpixelblue_sva = MUX_s_1_2_2({(findpixelblue_sva_dfm & (~ else_1_land_lpi_1_dfm))
                , findpixelblue_sva_dfm}, land_lpi_1_dfm);
            ...
            blueobjy_sva = MUX_v_10_2_2({blueobjy_sva , vga_y_sva}, findpixelblue_sva_dfm
                & else_1_land_lpi_1_dfm & (~ land_lpi_1_dfm));
            begin : waitLoop1Exit
